...
class MessageController extends Controller
{
    ...
    protected function attachReadStatus(
        Conversation $conversation,
        $viewer,
        $messages
    ): void {
        ...
        $otherPivot = $conversation->participants()
        ...
        $lastRead = \Illuminate\Support\Carbon::parse(
            $otherPivot->last_read_at
        );
        ...
        foreach ($messages as $message) {
            if ($message->sender_id === $viewer->id) {
                $message->setAttribute(
                    ...
                    $lastRead->greaterThanOrEqualTo($message->created_at)
                );
            }
        }
    }
